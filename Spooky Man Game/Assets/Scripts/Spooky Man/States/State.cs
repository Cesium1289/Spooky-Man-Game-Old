...
public class State
{
    ...
    protected SpookyManUtility utility;
    protected SpookyManAudio audio;
    public State()
    {
        currentStage = STAGE.ENTER;
    }

    public State(GameObject npc, NavMeshAgent agent, Animator animator, GameObject player, SpookyManUtility utility, SpookyManAudio audio)
    {
        this.npc = npc;
